        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="max-w-xl space-y-6 animate-fade-in text-center md:text-left">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center md:justify-start gap-4">
              ...
              <Button variant="outline" className="border-white hover:bg-white/10 px-8 py-6 text-lg text-zinc-50">
                Order Now
              </Button>
            </div>
          </div>
          ...
          <div className="hidden md:flex w-1/2 items-center justify-center">
            <img src="/lovable-uploads/3d98dbd5-f125-4671-9bc2-ad8e0d6c0577.png" alt="English breakfast with eggs, toast, mushrooms, beans and tomatoes" className="max-w-[450px] w-full mx-auto animate-float" />
          </div>
        </div>
      </div>
